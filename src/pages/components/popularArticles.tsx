...
interface PopularArticleItem {
 ...
 export const popularArticleItems: PopularArticleItem[] = [
    ...
    // { title: 'Cómo quitar los enlaces ocultos de las plantillas Joomla', url:'/como-quitar-los'},
    ...
    // { title: 'Cómo optimizar el contenido multimedia para SEO', url:'/como-optimizar'},
