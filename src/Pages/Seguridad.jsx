...
const Seguridad = () => {
  ...
  return (
    <>
      <section className='seguridad seo'>
        <BreadCrumb />
...
<br />                
                <div className='column'>
                    <div className="service-content-head"><span title="Ventajas de elegir cloud servers">Ventajas de elegir cloud servers</span></div>
...
<br />
                <div className='column'>
                    <div className="service-content-head"><span title="Como Protegerse contra ataques DDOS">Como Protegerse contra ataques DDOS</span></div>
...
<br />
                <div className='column'>
                    <div className="service-content-head"><span title="Como comprobar si mi sitio ha sido hackeado">Como comprobar si mi sitio ha sido hackeado</span></div>
...
<br />
                <div className='column'>
                    <div className="service-content-head"><span title="Elegir un proveedor de alojamiento calificado">Elegir un proveedor de alojamiento calificado</span></div>
...
<br />
                <div className='column'>
                    <div className="service-content-head"><span title="Como proteger un directorio usando cpanel">Como proteger un directorio usando cpanel</span></div>

                    <div className="service-content-txt">
                        <p><img src="\images\cpanel.jpg" alt="Como proteger un directorio usando cpanel" width='328' height='184' title='Como proteger un directorio usando cpanel' /> Es importante, por <strong>seguridad</strong> que usted sepa como proteger un directorio usando Cpanel. La <strong>seguridad</strong> de su sitio es vital, cr&iacute;tica y todo lo que pueda hacer para proteger su sitio siempre ser&aacute; poco.</p>

                        <p>Este tutorial te mostrar&aacute; c&oacute;mo proteger un directorio usando cPanel.</p>
...
<br />
                <div className='column'>
                    <div className="service-content-head"><span title="&iquest;C&oacute;mo puedo saber si mi sitio est&aacute; infectado?">&iquest;C&oacute;mo puedo saber si mi sitio est&aacute; infectado?</span></div>
...
<br />
                <div className='column'>
                    <div className="service-content-head"><span title="Las Vulnerabilidades L&oacute;gicas">Las Vulnerabilidades L&oacute;gicas</span></div>
...
<br />
                <div className='column'>
                    <div className="service-content-head"><span title="Proteja su sitio contra ataques de fuerza bruta">Proteja su sitio contra ataques de fuerza bruta</span></div>

                    <div className="service-content-txt">
                        <p><img src="\images\ataques de fuerza bruta.jpg" alt="proteja su sitio contra ataques de fuerza bruta" width='275' height='183' /> En el art&iacute;culo &quot;<Link to="/blog/joomla" title="Importancia de usar un nombre de usuario y contraseña fuerte " className='primary-color'>Importancia de usar un nombre de usuario y contrase&ntilde;a fuerte</Link>&quot;&nbsp;refimos su relevancia en funci&oacute;n de la seguridad del sitio.&nbsp;</p>
...
<br />
                <div className='column'>
                    <div className="service-content-head"><span title="Importancia del archivo robots.txt para la seguridad y el seo">Importancia del archivo robots.txt para la seguridad y el seo</span></div>
