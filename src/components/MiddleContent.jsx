...
const MiddleContent = () => {
  return (
    <div className="service-content">
        <div className="service-content-head"><span title="Diseño de Paginas web y seo. Acelerar sitio Joomla">Diseño de Paginas web y seo. Acelerar sitio Joomla</span></div>
        ...
        <div className="service-content-txt">
            ...
            <p>Construimosy <strong>diseñamos</strong> su sitio web en Joomla.<strong> Aceleraramos sitio Joomla</strong> Asesoramiento sobre el nombre de dominio más adecuado para su negocio. Realizamos un estudio para ofrecer a nuestros clientes la solución más adecuada a sus necesidades. Damos de alta su sitio web en los principales buscadores. Podemos llevar tu campaña <strong>SEO</strong> SEM, <strong>posicionando tu sitio web en Google</strong>. Ofrecemos un hosting &#40;alojamiento&#41;profesional a un precio sin competencia. Desarrollamos su tienda online. <strong>Seo</strong>&#40;<strong>posicionamiento en buscadore</strong>s&#41;.</p>
